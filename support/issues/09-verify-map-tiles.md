...
Partly de-risked already: `SquachLogo` uses the identical canvas + `lv_draw_image`-from-file path and works, for opaque palette PNGs - which is exactly what tiles are.
