...
void MeshtasticScreen::create(MeshtasticService *service, BackCallback backCallback, void *userData)
{
    ...
    // height label that silently clipped anything past its first ~9 lines.
    lv_obj_t *nodesBox = lv_obj_create(_screen);
    lv_obj_set_size(nodesBox, 374, 180);
    ...
    lv_obj_set_size(messagesBox, 374, 72);
    lv_obj_set_pos(messagesBox, 18, 394);
